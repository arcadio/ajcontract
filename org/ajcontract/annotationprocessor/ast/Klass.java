...
public class Klass extends Type<Klass> {
    ...
    public void addContractConstructor(ExecutableElement constructor, Requires requires) {
        Constructor c = getConstructor(constructor);
        c.setRequires(requires);
    }

    public void addContractConstructor(ExecutableElement constructor, Ensures ensures) {
        Constructor c = getConstructor(constructor);
