...
public class ParameterList {
    ...
    public static ParameterList parameterListFor(Element element, Executable<?> executable) {
    ...
    private String buildListRepresentation(ParameterBuilder builder) {
        ...
        while (parameterIterator.hasNext()) {
            parameterRepresentation.append(builder.getParameterRepresentation(parameterIterator.next()));
