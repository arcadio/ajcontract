...
public class CodeUtils {
    ...
    public static String getUniqueNamePrecondition(ExecutableElement executableElement) {
        return getUniqueName(executableElement) + "Pre";
    }

    public static String getUniqueNamePostcondition(ExecutableElement executableElement) {
    ...
    private static String getType(DeclaredType declaredType) {
        ...
        if (!declaredType.getTypeArguments().isEmpty()) {
            ...
            typeBuilt.append('<');
            Iterator<? extends TypeMirror> parameters =
