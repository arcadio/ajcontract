...
public class AJContractAnnotationProcessor extends AbstractProcessor {
    ...
    private void processAnnotations(Set<? extends TypeElement> annotations, RoundEnvironment roundEnv) {
        for (TypeElement te : annotations) {
            Set<? extends Element> annotated = roundEnv.getElementsAnnotatedWith(te);
            for (Element e : annotated) {
                try {
                    Class<?> c = Class.forName(te.getQualifiedName().toString());
                    Annotation a = e.getAnnotation((Class<? extends Annotation>) c);
                    process(e, a);
    ...
    private void processConstructor(ExecutableElement constructor, Annotation annotation) {
